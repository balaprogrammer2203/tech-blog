...
export function SiteHeader() {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 overflow-visible border-b border-gray-200/80 bg-white/90 shadow-sm backdrop-blur-md dark:border-gray-800 dark:bg-gray-950/90">
        <div className="mx-auto max-w-7xl px-4 py-3 lg:px-6">
          <div className="flex items-start justify-between gap-3 md:justify-start lg:gap-4">
            <div className="flex shrink-0 items-center gap-2">
              ...
              <Link
                to="/"
                className="truncate text-lg font-bold tracking-tight text-ink transition hover:text-emerald-700 dark:text-gray-50 dark:hover:text-emerald-400"
              >
                DevWrite
              </Link>
            </div>

            <div className="relative hidden min-w-0 flex-1 flex-col gap-2 md:flex">
        ...
        <div className="border-t border-gray-100 px-4 py-2 sm:hidden dark:border-gray-900 lg:px-6">
          <HeaderSearch />
        </div>
      </header>
      <MobileNavDrawer
